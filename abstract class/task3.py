...
class ConcreteClass(AbstractClassExample):
    ...
    def create_instance_and_call_methods(self):
        ...
        # Calling the abstract method that is implemented in the subclass
...
if __name__ == "__main__":
    # Create an instance of the child class and call the methods
    concrete_instance = ConcreteClass(20)
    concrete_instance.create_instance_and_call_methods()
